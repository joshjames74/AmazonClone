...
export default function NavigationSidebar(props: NavigationSidebarType): JSX.Element {

    const { categories } = useContext(SettingsContext);

    const [priceRange, setPriceRange] = useState<[number, number]>([props.minPrice, props.maxPrice])
