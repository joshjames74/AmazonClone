...
export default function RatingsOverview(): JSX.Element {
    ...
    const renderStarGraph = (stars: number, count: number, key: number): JSX.Element => {
        ...
        maxW='50vh'>
            ...
            w='100%'>
                ...
                w='100%'>
                    ...
                    <Box
                    marginLeft='5px'>{productInfo.reviewScore} out of 5</Box>
                </Box>
