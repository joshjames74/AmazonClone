...
export function toReviewEntity(review: ReviewType, product_id: number, user_id: number): Review {
...
export async function addReview(review: ReviewType, product_id: number, user_id: number): Promise<any> {
...
export async function getReviewListByProductId(id: number): Promise<ReviewType[]> {
