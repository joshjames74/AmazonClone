import { FormLabel, Input, Box, InputGroup, InputLeftAddon, Select } from '@chakra-ui/react';
...
export default function CurrencyInputBox(props: ICurrencyInputBoxProps): JSX.Element {
