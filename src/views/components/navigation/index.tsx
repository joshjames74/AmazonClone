...
import ProductCardWrapper, { ProductCardWrapperProps } from "../product/ProductCardWrapper";
...
export default function Navigation(): JSX.Element {
    ...
    const productCardProps: ProductInfo = {
        productId: 0,
        title: 'iPhone 8',
    ...
    const productWrapperProps: ProductCardWrapperProps = {
